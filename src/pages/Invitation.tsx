    ...
    const getPost = async (username: string) => {
      try {
        const res = await axios.get(
          `${import.meta.env.VITE_REACT_APP_API_URL}/guest/${username}`
        );
    ...
    <div>
      <Helmet>
        ...
        <meta
          ...
          content={`You are invited to the wedding of ${invitee}.`}
        />
        <meta property="og:image" content={thumbnail} />
        <meta
          property="og:url"
          content={`https://our-happy-days.vercel.app/${username}`}
        />
      </Helmet>
      <div
        className={`fixed inset-y-0 bg-maroon transition-transform duration-1000 ${
          isVisible ? "" : "-translate-x-full md:-translate-x-220"
      ...
      >
        ...
        <div
          className="flex-col relative h-3/5 bg-cover bg-bottom "
        ...
        <div className="relative flex flex-col -mt-28 items-center text-white h-1/2">
          <div className="flex flex-col items-center gap-2 h-32 mb-8">
            <img
              ...
              alt="Ring Decoration"
            />
            <p className="font-cinzel-decorative text-2xl tracking-[.4em] pl-2">
              fauzi
            </p>
            <p className="font-delicious text-6xl -mt-7 -mb-7">and</p>
            <p className="font-cinzel-decorative [21px] text-2xl tracking-[.4em] pl-2">
              fauriza
            </p>
            <p className="font-cinzel-decorative text-sm/[11px] tracking-[.25em]">
              wedding invitation
            </p>
          </div>
