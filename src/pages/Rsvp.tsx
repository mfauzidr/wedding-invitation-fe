  ...
  return (
    <div className="relative w-full min-h-screen bg-maroon">
      <div className="relative flex flex-col items-center">
        ...
        <div className="font-the-seasons mt-16 text-white text-4xl py-2 tracking-tight">
          RSVP & Wishes
        </div>
      </div>
      <form
        onSubmit={handleSubmit}
        className="flex flex-col gap-2 px-10 mt-6 mb-6 font-bellefair"
      >
        <label
          htmlFor="name"
          className="flex w-full justify-start text-white text-lg"
        >
          Nama:
        </label>
        <input
      ...
      <div className="flex h-96">
        ...
        <div className="absolute w-full h-96 flex flex-col justify-between items-center py-8">
          <div className="flex font-great-vibes text-white text-6xl">
            Thank You
          </div>
          <div className="flex flex-col font-cinzel-decorative text-white items-center">
            ...
            <div className="text-2xl tracking-[.25em] mb-1">
              fauzi & fauriza
            </div>
            <div className="text-sm tracking-[0.1em]">28 Januari 2025</div>
          </div>
        </div>
      </div>
