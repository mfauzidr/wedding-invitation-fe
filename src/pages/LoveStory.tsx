  ...
  return (
    <div className="relative w-full min-h-screen" ref={observerRef}>
      ...
      <div className="absolute inset-0 max-w-md min-h-screen overflow-hidden">
        <img
          src={bg}
          className="w-full h-full object-cover object-bottom bottom-0 scale-125 overflow-hidden inset-"
          alt="Background"
        />
      ...
      <div className="relative z-10 flex flex-col items-center inset-x-0">
        ...
        {/* Header Section */}
        <div
          className={`font-cinzel-decorative mt-16 text-white text-3xl py-2 border-y z-10 ${
            visibleItems[0]
        ...
        <div className="flex flex-col gap-6 font-cardo italic text-white mx-8 text-xl/[22px] z-10">
          ...
          >
            ...
            <div className="pb-4 pt-1">
              Kami berkenalan di sebuah komunitas cosplay dan setelah 1 bulan
              berkenalan kami menyatakan bahwa kami saling suka.
            </div>
          ...
          >
            ...
            <div className="pb-4 pt-1">
              Setelah berpacaran selama 5 tahun, kami menemukan masalah besar
              yang tidak bisa kami selesaikan dengan baik kali ini..
            </div>
            <div className="border border-white w-3/5"></div>
          </div>
          <div
          ...
          >
            ...
            <div className="pb-4 pt-1">
              1,5 tahun berpisah menyadarkan kami bahwa tidak ada orang lain
              yang bisa menggantikan kami satu sama lain.
            </div>
            <div className="border border-white w-3/5"></div>
          </div>
          <div
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-2">2025</div>
            </div>
            <div className="pb-4 pt-1">
              Akhirnya jalan 9 tahun bersama kami memutuskan untuk ke jenjang
              yang lebih serius.
            </div>
          </div>
        </div>
