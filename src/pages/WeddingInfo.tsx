    ...
    <div className="relative w-full min-h-screen bg-maroon" ref={observerRef}>
      <div className="relative min-h-screen flex flex-col items-center">
        ...
        <div className="flex flex-col bg-white rounded-[4rem] mx-2 p-3 items-center mt-14">
          <div
            className={`font-the-seasons text-3xl text-maroon z-10 ${
              visibleItems[0] ? "fade-in fade-in-slide-up" : "fade-out-slide-up"
            }`}
          >
            Save The Date
          </div>
          ...
          <div
            className={`flex justify-center items-center mt-5 text-maroon ${
              visibleItems[1] ? "fade-in fade-in-slide-up" : "fade-out-slide-up"
            }`}
          >
            {/* Left section */}
            <div className="flex items-center justify-center mr-4 italic w-[70px] border-y h-8 border-maroon">
              <div className="text-xs font-cardo">SELASA</div>
            </div>
            <div className="flex flex-col items-center text-center font-bellefair">
              ...
              <div className="text-6xl font-great-vibes text-maroon">28</div>
          ...
          <div
            className={`relative w-[335px] h-[71px] mt-5 ${
              visibleItems[2] ? "fade-in fade-in-slide-up" : "fade-out-slide-up"
            }`}
          >
            ...
            <div
              className={`absolute inset-0 flex justify-between items-center px-10 font-cardo ${
                visibleItems[2]
                  ? "fade-in fade-in-slide-up"
                  : "fade-out-slide-up"
              }`}
          ...
          <div
            className={`flex mt-5 items-center gap-2 ${
              visibleItems[3] ? "fade-in fade-in-slide-up" : "fade-out-slide-up"
            }`}
          >
            <img src={houseIcon} alt="House Icon" className="w-14 h-12" />
            <div className="flex flex-col justify-center">
              <div className="font-cardo text-xs">
                Bertempat di kediaman mempelai wanita
              </div>
              <div className="font-cardo text-sm text-maroon italic">
                Jl. Gunung Karang RT 03 RW 09, Kelurahan
              </div>
              <div className="font-cardo text-sm text-maroon italic">
                Limus Nunggal, Cibeureum, Kota Sukabumi
              </div>
            </div>
          </div>
          <button
            ...
            onClick={() =>
              window.open(
                "https://maps.app.goo.gl/bcfHY7EDzugwvgjd6",
                "_blank",
                "noopener noreferrer"
              )
            }
          ...
          <div className="mt-5 font-cardo text-maroon text-sm">
            Dress Code : Maroon / Grey
          </div>
        </div>
